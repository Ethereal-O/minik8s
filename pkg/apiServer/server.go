...
func Start_server() {
	...
	e.PUT("/DaemonSet/:key", daemonset_put)
	e.GET("/DaemonSet/:key", daemonset_get)
	e.DELETE("/DaemonSet/:key", daemonset_delete)
	...
	e.PUT("/VirtualService/:key", virtualService_put)
	e.GET("/VirtualService/:key", virtualService_get)
	e.DELETE("/VirtualService/:key", virtualService_delete)
